...
export default function Container(props) {
  ...
  const meta = {
    title: "Alkis Lorantos - Software Engineer",
    description: `16 year old software enginer`,
  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        />
        <link rel="canonical" href={`https://alkislorantos.com${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Alkis Lorantos" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@alkis_lorantos" />
